...
public class Main {
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            SongsController songsController = new SongsController(mainView.getHomeView().getSongsView(), businessFacade, mainView.getHomeView().getStatisticsView());
            ...
            AddSongsController addSongsController = new AddSongsController(mainView.getHomeView().getAddSongsView(),mainView.getHomeView(),businessFacade, mainView.getHomeView().getStatisticsView());
